...
public class Auth extends HttpServlet implements PropertiesLoader {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (authCode == null) {
            ...
            logger.warn("No auth code provided in request, redirecting to login page");
            ...
            try {
                ...
                RequestDispatcher dispatcher = req.getRequestDispatcher("authError.jsp"); // create this page
